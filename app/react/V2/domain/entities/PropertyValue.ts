/**
 * Unified Property Value Structure
 * Consistent value representation across all property types
 */
...
// Unified type-specific value structures (no single vs array distinction)
...
// Union type for all property values (simplified)
...
// Normalized property descriptor
