...
export default function EntityPreviewWithLoader() {
    ...
    const { entity, compositions, performance } = loaderData as {
        entity: any;
        compositions: {
            full: ComposedEntity | null;
            dateFields: ComposedEntity | null;
            selectFields: ComposedEntity | null;
        };
        performance: {
    ...
    const renderComposition = (title: string, entity: ComposedEntity | null, color: string) => (
        <div style={{
    ...
    return (
        <div style={{
            ...
            {renderComposition(
                '1. Full Entity Composition (All Fields)',
                compositions.full,
                '#0066cc'
            )}
