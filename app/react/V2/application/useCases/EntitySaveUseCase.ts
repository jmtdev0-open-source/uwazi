...
export class EntitySaveUseCaseImpl implements EntitySaveUseCase {
    ...
    async saveEntity(entityId: string, formData: any, options: SaveOptions = {}): Promise<SaveResult> {
        try {
            ...
            if (options.showNotifications !== false) this.showSuccessNotification('Entity updated successfully');
