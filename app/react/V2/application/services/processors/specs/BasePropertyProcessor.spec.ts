...
class TestBasePropertyProcessor extends BasePropertyProcessor {
  ...
  protected formatProperty(property: any, context: ProcessingContext): any[] {
...
describe('BasePropertyProcessor', () => {
  ...
  describe('Utility Methods', () => {
    ...
    it('should build property metadata correctly', () => {
      ...
      const metadata = processor.buildPropertyMetadata(property, 'fieldName', mockContext);
    ...
    it('should detect inherited properties', () => {
      ...
      const isInherited = processor.isInheritedProperty(inheritedProperty);
    ...
    it('should detect non-inherited properties', () => {
      ...
      const isInherited = processor.isInheritedProperty(regularProperty);
  ...
  describe('Translation Support', () => {
    it('should handle missing translations gracefully', () => {
      ...
      const translatedLabel = processor.getTranslatedLabel(property, 'fieldName', mockContext);
