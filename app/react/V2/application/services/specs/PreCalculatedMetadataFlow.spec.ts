...
jest.mock('app/V2/atoms', () => ({
  atomStore: mockAtomStore,
}));
  ...
  describe('Entity Processing Flow', () => {
    it('should process entities successfully', async () => {
      const processor = EntityAdapterFactory.createPipeline(testOptions, {
        ...
        settings: mockAtomStore.get('settingsAtom'),
        templates: mockAtomStore.get('templatesAtom'),
        translations: mockAtomStore.get('translationsAtom'),
      });
